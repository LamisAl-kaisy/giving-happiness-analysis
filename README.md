...
│   └── 03\_final\_analysis.ipynb

│

├── outputs/

│   ├── giving\_happiness\_clean.csv

│   ├── exploratory\_summary.csv

│   ├── final\_model\_results.csv

│   ├── life\_satisfaction\_by\_donor.png

│   └── donor\_regression\_effect.png
...
This project uses data from the Panel Study of Income Dynamics (PSID), conducted by the Survey Research Center at the University of Michigan Institute for Social Research.

PSID data are not included in this repository. The analysis code and derived summary outputs are provided for reproducibility.
